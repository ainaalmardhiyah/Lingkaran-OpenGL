...
void init();
void display(void);
void lingkaran(int jari2, int hor, int ver);
...
void init()
{
	glClearColor(0.0, 0.0, 1.0, 0.0); //set warna background 
...
void display(void)
{
	...
	lingkaran(20, 250, 300); //jalankan fungsi lingkaran
	lingkaran(10, 250, 300); //jalankan fungsi lingkaran 

	lingkaran(40, 350, 300); //jalankan fungsi lingkaran
	lingkaran(20, 350, 300); //jalankan fungsi lingkaran
	lingkaran(10, 350, 300); //jalankan fungsi lingkaran

	lingkaran(100, 300, 300); //jalankan fungsi lingkaran
